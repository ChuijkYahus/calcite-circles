...
import hexdoc_calcite

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class CalcitePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return CalciteModPlugin(branch=branch)


class CalciteModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "calcite"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_calcite, "_templates"
